...
<BODY>
   ...
   // Conectar con el servidor de base de datos
      $conexion = mysqli_connect ("localhost", "root", "asdf")
   ...
   // Mostrar resultados de la consulta
      $nfilas = mysqli_num_rows ($consulta);
	   echo "Numero de filas: ".$nfilas."<br>";
      if ($nfilas > 0)
      {
         print ("<TABLE>\n");
         print ("<TR>\n");
   ...
   <div>
      <a href="actualizar_piso1.html">actualizar</a>
      <a href="add_piso1.html">añadir</a>
      <a href="eliminar_piso1.html">eliminar</a>
   </div>
</BODY>
</HTML>
