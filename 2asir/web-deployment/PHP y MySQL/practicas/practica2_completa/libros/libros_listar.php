                ...
                <div class="table-container">
                    <?php if (isset($error_detalle)) { ?>
                        <div class="error-message"
                            ...
                            Error de conexión: <?php echo mysqli_connect_error(); ?>
                        </div>
                        ...
                        <?php while ($fila = mysqli_fetch_assoc($resultado)) { ?>
                            <div class="tarjeta">
                                ...
                                <div class="info">
                                    ...
                                    <div class="acciones">
                                        <a href="libros_modificar.php?id=<?php echo $fila['id_libro']; ?>"
                                            class="btn-editar">Editar</a>
                                        <a href="libros_borrar.php?id=<?php echo $fila['id_libro']; ?>" class="btn-borrar"
                                            onclick="return confirm('¿Estás seguro de borrar este libro?')">Borrar</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
