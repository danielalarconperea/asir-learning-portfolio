...
if ($conexion) {
    ...
    // Si viene un ID por GET, forzar la búsqueda de ese libro específico
    if (isset($_GET['id']) && !isset($_POST['buscar'])) {
        $id_lib_get = mysqli_real_escape_string($conexion, $_GET['id']);
        $consulta = "SELECT * FROM Libros WHERE id_libro = '$id_lib_get'";
