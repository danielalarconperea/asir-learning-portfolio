                        ...
                        <?php while ($fila = mysqli_fetch_assoc($resultado)) { ?>
                            <div class="tarjeta loan-card">
                                <div class="info">
                                    ...
                                    <div class="acciones">
                                        <a href="prestamos_modificar.php?id=<?php echo $fila['id_prestamo']; ?>"
                                            class="btn-editar">Gestionar</a>
                                        <a href="prestamos_borrar.php?id=<?php echo $fila['id_prestamo']; ?>" class="btn-borrar"
                                            onclick="return confirm('¿Estás seguro de borrar este registro de préstamo?')">Borrar</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
