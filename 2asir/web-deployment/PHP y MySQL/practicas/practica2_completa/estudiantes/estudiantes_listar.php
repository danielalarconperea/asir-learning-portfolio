                        ...
                        <?php while ($fila = mysqli_fetch_assoc($resultado)) { ?>
                            <div class="tarjeta student-card">
                                <div class="info">
                                    ...
                                    <div class="acciones">
                                        <a href="estudiantes_modificar.php?id=<?php echo $fila['id_estudiante']; ?>"
                                            class="btn-editar">Editar</a>
                                        <a href="estudiantes_borrar.php?id=<?php echo $fila['id_estudiante']; ?>"
                                            class="btn-borrar"
                                            onclick="return confirm('¿Estás seguro de borrar este estudiante?')">Borrar</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
