...
# [Apartado 1: VLANs y Direccionamiento SVI]
vlan 20
 name Datos_VLAN20
vlan 50
...
# [Apartado 1 y 10: Puertos de Acceso VLAN 20 (PC-A1), PortFast y Port-Security en CORE]
interface g1/0/11
...
# [Apartado 1 y 10: Puertos de Acceso VLAN 50 (PC-A2), PortFast y Port-Security en CORE]
interface g1/0/1
 switchport mode access
...
interface range g1/0/2 - 10, g1/0/12 - 20, g1/0/23 - 24
...
# [Apartado 2: Etherchannel (LACP) hacia SW1]
