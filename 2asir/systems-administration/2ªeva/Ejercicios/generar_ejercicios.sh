#!/bin/bash
# Script para regenerar todos los ejercicios de Administración de Sistemas

echo "Iniciando la creación de los directorios de ejercicios..."

# Crear directorios
mkdir -p "1-Ejercicios basicos"
mkdir -p "2-Ejercicios avanzados"

echo "Creando Ejercicios Básicos..."

# --- BASICOS ---

cat << 'EOF' > "1-Ejercicios basicos/1_config_path.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/2_usuarios.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/3_quiensoy.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/4_dimecron.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/5_numusu.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/6_masmemoria.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/7_modi_cron.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/8_hola.sh"
#!/bin/bash
# Ejercicio 8: hola.sh
...
cat << 'EOF' > "1-Ejercicios basicos/9_calc.sh"
#!/bin/bash
# Ejercicio 9: calc.sh
...
cat << 'EOF' > "1-Ejercicios basicos/10_tama_dir.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/11_grupos_usu.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/12_usu_grupo.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/13_nuevos.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/14_cron_usuario.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/15_calc_para.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/15_hola_para.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/16_pon_numeros.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/17_busca_fichero.sh"
#!/bin/bash
...
cat << 'EOF' > "1-Ejercicios basicos/18_ejecutar.sh"
#!/bin/bash
...
echo "Creando Ejercicios Avanzados..."

# --- AVANZADOS ---

cat << 'EOF' > "2-Ejercicios avanzados/1_control_params.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/2_comparar.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/3_existe_usuario.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/4_grupos_compartidos.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/5_menu_usuarios.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/6_hasta_fin.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/7_permisos_texto.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/8_menu_permisos.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/9_menu_red.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/10_check_bin.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/11_donde_esta.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/12_calendario.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/13_citas.sh"
#!/bin/bash
...
cat << 'EOF' > "2-Ejercicios avanzados/14_citas-menu.sh"
#!/bin/bash
...
# Asignar permisos de ejecución a todos los ficheros creados
chmod +x "1-Ejercicios basicos"/*.sh
chmod +x "2-Ejercicios avanzados"/*.sh

echo "Regeneración completada con éxito. Todos los archivos tienen permisos de ejecución."
